...
public class DepthCacheExample {
	 ...
	 */
	private void applyPendingDeltas(List<DepthEvent> pendingDeltas) {
		Consumer<DepthEvent> updateOrderBook = newEvent -> {
	...
	private final class WsCallback implements BinanceApiCallback<DepthEvent> {
		...
		private void setHandler(Consumer<DepthEvent> handler) {
